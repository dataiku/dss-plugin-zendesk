...
def test_run_read_zendesk_search(user_dss_clients):
    dss_scenario.run(user_dss_clients, 'PLUGINTESTZENDESK', 'run_read_zendesk_search', user="user1")


def test_run_read_zendesk_tickets(user_dss_clients):
    dss_scenario.run(user_dss_clients, 'PLUGINTESTZENDESK', 'run_read_zendesk_tickets', user="user1")


def test_run_read_zendesk_user_clients(user_dss_clients):
    dss_scenario.run(user_dss_clients, 'PLUGINTESTZENDESK', 'run_read_zendesk_users', user="user1")
